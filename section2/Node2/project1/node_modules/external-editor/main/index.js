...
(function() {
  ...
  CreateFileError = require('external-editor/main/errors/CreateFileError');

  ReadFileError = require('external-editor/main/errors/ReadFileError');

  RemoveFileError = require('external-editor/main/errors/RemoveFileError');

  LaunchEditorError = require('external-editor/main/errors/LaunchEditorError');
